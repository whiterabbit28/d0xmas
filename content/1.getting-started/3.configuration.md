...
export default defineAppConfig({
  header: {
    ...
    logo: {
      // Light mode
      light: {
        src: '/assets/images/logo-light.png', // Path to the logo image for light mode
        alt: 'Your Logo', // Alternative text for the logo
        class: 'logo-light', // Optional CSS class for the logo
      },
      // Dark mode
      dark: {
        src: '/assets/images/logo-dark.png', // Path to the logo image for dark mode
        alt: 'Your Logo', // Alternative text for the logo
        class: 'logo-dark', // Optional CSS class for the logo
        }
      },
